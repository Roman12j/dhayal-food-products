  ...
  return <>
    <header className="header">
      <div className="header-top container">
        ...
        <div className="header-contact"><MapPin /><span>Vishwakarma Colony,<br />Jaipur, Rajasthan</span></div>
    ...
    <footer><div className="container footer-inner"><div><img className="footer-logo" src="/assets/logo.png" alt="Dhayal Food Products" /><p>Traditional taste, thoughtfully prepared.</p></div><div><b>Visit us</b><p>Behind Jain PG College, Road No. 5,<br />Vishwakarma Colony, Jaipur</p></div><div><b>Call us</b><a href="tel:8279287203">8279 287 203</a><a href="https://wa.me/918279287203" target="_blank" rel="noreferrer">WhatsApp us</a></div></div><p className="copyright">© {new Date().getFullYear()} Dhayal Food Products. Made with care.</p></footer>
